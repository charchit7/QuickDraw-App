...
def main():
    ...
    model = Model(FLAGS.model, device, dataloader,
                  FLAGS.channels, FLAGS.l1_coef, FLAGS.l2_coef)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str,
                        default='text2image', help='text2image')
    parser.add_argument('--cuda', type=utils.boolean_string,
                        default=True, help='enable CUDA.')
    parser.add_argument('--train', type=utils.boolean_string,
                        default=True, help='train mode or eval mode.')
    parser.add_argument('--data_dir', type=str,
                        default='./data/text2image/birds', help='Directory for dataset.')
    parser.add_argument('--dataset', type=str,
                        default='birds', help='Dataset name.')
    ...
    parser.add_argument('--l1_coef', type=float,
                        default=50, help='l1 coefficient')
    parser.add_argument('--l2_coef', type=float,
                        default=100, help='l2 coefficient')
